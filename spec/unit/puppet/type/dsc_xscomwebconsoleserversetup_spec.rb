...
describe Puppet::Type.type(:dsc_xscomwebconsoleserversetup) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscomwebconsoleserversetup[:dsc_ensure] = 'present'
    expect(dsc_xscomwebconsoleserversetup[:ensure]).to eq(dsc_xscomwebconsoleserversetup.provider.munge_ensure(dsc_xscomwebconsoleserversetup[:dsc_ensure].downcase).to_sym)
  end
