...
describe Puppet::Type.type(:dsc_xexchoabvirtualdirectory) do
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_allowservicerestart" do
    ...
    expect(dsc_xexchoabvirtualdirectory[:dsc_allowservicerestart]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_allowservicerestart" do
    ...
    expect(dsc_xexchoabvirtualdirectory[:dsc_allowservicerestart]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_basicauthentication" do
    ...
    expect(dsc_xexchoabvirtualdirectory[:dsc_basicauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_basicauthentication" do
    ...
    expect(dsc_xexchoabvirtualdirectory[:dsc_basicauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_requiressl" do
    ...
    expect(dsc_xexchoabvirtualdirectory[:dsc_requiressl]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_requiressl" do
    ...
    expect(dsc_xexchoabvirtualdirectory[:dsc_requiressl]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_windowsauthentication" do
    ...
    expect(dsc_xexchoabvirtualdirectory[:dsc_windowsauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_windowsauthentication" do
    ...
    expect(dsc_xexchoabvirtualdirectory[:dsc_windowsauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
