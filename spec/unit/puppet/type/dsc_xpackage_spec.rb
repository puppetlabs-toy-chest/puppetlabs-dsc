...
describe Puppet::Type.type(:dsc_xpackage) do
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_installed" do
    ...
    expect(dsc_xpackage[:dsc_installed]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_installed" do
    ...
    expect(dsc_xpackage[:dsc_installed]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_createcheckregvalue" do
    ...
    expect(dsc_xpackage[:dsc_createcheckregvalue]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_createcheckregvalue" do
    ...
    expect(dsc_xpackage[:dsc_createcheckregvalue]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
