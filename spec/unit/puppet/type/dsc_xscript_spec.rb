...
describe Puppet::Type.type(:dsc_xscript) do

  let :dsc_xscript do
    Puppet::Type.type(:dsc_xscript).new(
      :name     => 'foo',
      :dsc_getscript => 'foo',
      :dsc_setscript => 'foo',
      :dsc_testscript => 'foo',
  ...
  it "should stringify normally" do
    expect(dsc_xscript.to_s).to eq("Dsc_xscript[foo]")
  end

  it 'should require that dsc_getscript is specified' do
    #dsc_xscript[:dsc_getscript]
    expect { Puppet::Type.type(:dsc_xscript).new(
      :name     => 'foo',
      :dsc_setscript => 'foo',
      :dsc_testscript => 'foo',
  ...
  it 'should not accept array for dsc_getscript' do
    expect{dsc_xscript[:dsc_getscript] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_getscript' do
    expect{dsc_xscript[:dsc_getscript] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_setscript' do
    expect{dsc_xscript[:dsc_setscript] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_setscript' do
    expect{dsc_xscript[:dsc_setscript] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_testscript' do
    expect{dsc_xscript[:dsc_testscript] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_testscript' do
    expect{dsc_xscript[:dsc_testscript] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_credential' do
    expect{dsc_xscript[:dsc_credential] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_credential' do
    expect{dsc_xscript[:dsc_credential] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_result' do
    expect{dsc_xscript[:dsc_result] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  describe "powershell provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:powershell).new(dsc_xscript)
    end

    before(:each) do
      @provider = described_class.provider(:powershell).new(dsc_xscript)
    end
