...
describe Puppet::Type.type(:dsc_xspdistributedcacheservice) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xspdistributedcacheservice[:dsc_ensure] = 'present'
    expect(dsc_xspdistributedcacheservice[:ensure]).to eq(dsc_xspdistributedcacheservice.provider.munge_ensure(dsc_xspdistributedcacheservice[:dsc_ensure].downcase).to_sym)
  end
