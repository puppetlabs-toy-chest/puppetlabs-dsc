...
describe Puppet::Type.type(:dsc_xspuserprofilesyncservice) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xspuserprofilesyncservice[:dsc_ensure] = 'present'
    expect(dsc_xspuserprofilesyncservice[:ensure]).to eq(dsc_xspuserprofilesyncservice.provider.munge_ensure(dsc_xspuserprofilesyncservice[:dsc_ensure].downcase).to_sym)
  end
