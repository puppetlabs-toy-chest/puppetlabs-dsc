...
describe Puppet::Type.type(:dsc_xscomwebconsoleserverupdate) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscomwebconsoleserverupdate[:dsc_ensure] = 'present'
    expect(dsc_xscomwebconsoleserverupdate[:ensure]).to eq(dsc_xscomwebconsoleserverupdate.provider.munge_ensure(dsc_xscomwebconsoleserverupdate[:dsc_ensure].downcase).to_sym)
  end
