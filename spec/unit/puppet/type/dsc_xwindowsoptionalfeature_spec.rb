...
describe Puppet::Type.type(:dsc_xwindowsoptionalfeature) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xwindowsoptionalfeature[:dsc_ensure] = 'present'
    expect(dsc_xwindowsoptionalfeature[:ensure]).to eq(dsc_xwindowsoptionalfeature.provider.munge_ensure(dsc_xwindowsoptionalfeature[:dsc_ensure].downcase).to_sym)
  end
