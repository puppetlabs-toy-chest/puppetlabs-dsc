...
describe Puppet::Type.type(:dsc_xscvmmmanagementserverupdate) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscvmmmanagementserverupdate[:dsc_ensure] = 'present'
    expect(dsc_xscvmmmanagementserverupdate[:ensure]).to eq(dsc_xscvmmmanagementserverupdate.provider.munge_ensure(dsc_xscvmmmanagementserverupdate[:dsc_ensure].downcase).to_sym)
  end
