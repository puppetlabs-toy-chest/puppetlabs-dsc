...
describe Puppet::Type.type(:dsc_spsearchindexpartition) do

  let :dsc_spsearchindexpartition do
    Puppet::Type.type(:dsc_spsearchindexpartition).new(
      :name     => 'foo',
      :dsc_index => 32,
    )
  end
  ...
  it 'should allow all properties to be specified' do
    expect { Puppet::Type.type(:dsc_spsearchindexpartition).new(
      :name     => 'foo',
      :dsc_index => 32,
  ...
  it "should stringify normally" do
    expect(dsc_spsearchindexpartition.to_s).to eq("Dsc_spsearchindexpartition[foo]")
  end

  it 'should require that dsc_index is specified' do
    #dsc_spsearchindexpartition[:dsc_index]
    expect { Puppet::Type.type(:dsc_spsearchindexpartition).new(
      :name     => 'foo',
  ...
  it 'should not accept array for dsc_index' do
    expect{dsc_spsearchindexpartition[:dsc_index] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_servers' do
    expect{dsc_spsearchindexpartition[:dsc_servers] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_rootdirectory' do
    expect{dsc_spsearchindexpartition[:dsc_rootdirectory] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_rootdirectory' do
    expect{dsc_spsearchindexpartition[:dsc_rootdirectory] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_serviceappname' do
    expect{dsc_spsearchindexpartition[:dsc_serviceappname] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it "should not accept empty password for dsc_installaccount" do
    expect{dsc_spsearchindexpartition[:dsc_installaccount] = {"user"=>"user", "password"=>""}}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_installaccount' do
    expect{dsc_spsearchindexpartition[:dsc_installaccount] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_installaccount' do
    expect{dsc_spsearchindexpartition[:dsc_installaccount] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  describe "powershell provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:powershell).new(dsc_spsearchindexpartition)
    end

    before(:each) do
      @provider = described_class.provider(:powershell).new(dsc_spsearchindexpartition)
    end
