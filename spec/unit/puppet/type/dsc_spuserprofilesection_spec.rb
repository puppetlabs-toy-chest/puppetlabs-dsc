...
describe Puppet::Type.type(:dsc_spuserprofilesection) do

  let :dsc_spuserprofilesection do
    Puppet::Type.type(:dsc_spuserprofilesection).new(
      :name     => 'foo',
      :dsc_name => 'foo',
    )
  end
  ...
  it 'should allow all properties to be specified' do
    expect { Puppet::Type.type(:dsc_spuserprofilesection).new(
      :name     => 'foo',
      :dsc_name => 'foo',
      :dsc_ensure => 'Present',
  ...
  it "should stringify normally" do
    expect(dsc_spuserprofilesection.to_s).to eq("Dsc_spuserprofilesection[foo]")
  end

  it 'should default to ensure => present' do
    expect(dsc_spuserprofilesection[:ensure]).to eq :present
  end

  it 'should require that dsc_name is specified' do
    #dsc_spuserprofilesection[:dsc_name]
    expect { Puppet::Type.type(:dsc_spuserprofilesection).new(
      :name     => 'foo',
  ...
  it 'should not accept array for dsc_name' do
    expect{dsc_spuserprofilesection[:dsc_name] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_name' do
    expect{dsc_spuserprofilesection[:dsc_name] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_spuserprofilesection[:dsc_ensure] = 'present'
    expect(dsc_spuserprofilesection[:ensure]).to eq(dsc_spuserprofilesection[:dsc_ensure].downcase.to_sym)
  end

  it 'should accept dsc_ensure predefined value Absent' do
    dsc_spuserprofilesection[:dsc_ensure] = 'Absent'
    expect(dsc_spuserprofilesection[:dsc_ensure]).to eq('Absent')
  end
  ...
  it 'should not accept values not equal to predefined values' do
    expect{dsc_spuserprofilesection[:dsc_ensure] = 'invalid value'}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_ensure' do
    expect{dsc_spuserprofilesection[:dsc_ensure] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_ensure' do
    expect{dsc_spuserprofilesection[:dsc_ensure] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_userprofileservice' do
    expect{dsc_spuserprofilesection[:dsc_userprofileservice] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_displayname' do
    expect{dsc_spuserprofilesection[:dsc_displayname] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_displayname' do
    expect{dsc_spuserprofilesection[:dsc_displayname] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it "should not accept empty password for dsc_installaccount" do
    expect{dsc_spuserprofilesection[:dsc_installaccount] = {"user"=>"user", "password"=>""}}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_installaccount' do
    expect{dsc_spuserprofilesection[:dsc_installaccount] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_installaccount' do
    expect{dsc_spuserprofilesection[:dsc_installaccount] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  describe "powershell provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:powershell).new(dsc_spuserprofilesection)
    end

    before(:each) do
      @provider = described_class.provider(:powershell).new(dsc_spuserprofilesection)
    end
    ...
    describe "when dsc_ensure is 'present'" do
      ...
      before(:each) do
        dsc_spuserprofilesection.original_parameters[:dsc_ensure] = 'present'
        dsc_spuserprofilesection[:dsc_ensure] = 'present'
        @provider = described_class.provider(:powershell).new(dsc_spuserprofilesection)
      end
    ...
    describe "when dsc_ensure is 'absent'" do
      ...
      before(:each) do
        dsc_spuserprofilesection.original_parameters[:dsc_ensure] = 'absent'
        dsc_spuserprofilesection[:dsc_ensure] = 'absent'
        @provider = described_class.provider(:powershell).new(dsc_spuserprofilesection)
      end

      it "should update :ensure to :absent" do
        expect(dsc_spuserprofilesection[:ensure]).to eq(:absent)
      end
