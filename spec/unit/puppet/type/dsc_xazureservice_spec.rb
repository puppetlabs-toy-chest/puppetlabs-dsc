...
describe Puppet::Type.type(:dsc_xazureservice) do
  ...
  describe "dsc_configuration provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:dsc_configuration).new(dsc_xazureservice)
    end

    before(:each) do
      @provider = described_class.provider(:dsc_configuration).new(dsc_xazureservice)
    end
  ...
  describe "mof provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:dsc_mof).new(dsc_xazureservice)
    end

    before(:each) do
      @provider = described_class.provider(:dsc_mof).new(dsc_xazureservice)
    end
