...
describe Puppet::Type.type(:dsc_xscvmmmanagementserversetup) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscvmmmanagementserversetup[:dsc_ensure] = 'present'
    expect(dsc_xscvmmmanagementserversetup[:ensure]).to eq(dsc_xscvmmmanagementserversetup.provider.munge_ensure(dsc_xscvmmmanagementserversetup[:dsc_ensure].downcase).to_sym)
  end
