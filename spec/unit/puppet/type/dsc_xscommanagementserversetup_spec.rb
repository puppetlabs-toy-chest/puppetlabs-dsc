...
describe Puppet::Type.type(:dsc_xscommanagementserversetup) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscommanagementserversetup[:dsc_ensure] = 'present'
    expect(dsc_xscommanagementserversetup[:ensure]).to eq(dsc_xscommanagementserversetup.provider.munge_ensure(dsc_xscommanagementserversetup[:dsc_ensure].downcase).to_sym)
  end
