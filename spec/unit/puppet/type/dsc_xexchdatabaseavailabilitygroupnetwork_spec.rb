...
describe Puppet::Type.type(:dsc_xexchdatabaseavailabilitygroupnetwork) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xexchdatabaseavailabilitygroupnetwork[:dsc_ensure] = 'present'
    expect(dsc_xexchdatabaseavailabilitygroupnetwork[:ensure]).to eq(dsc_xexchdatabaseavailabilitygroupnetwork.provider.munge_ensure(dsc_xexchdatabaseavailabilitygroupnetwork[:dsc_ensure].downcase).to_sym)
  end
