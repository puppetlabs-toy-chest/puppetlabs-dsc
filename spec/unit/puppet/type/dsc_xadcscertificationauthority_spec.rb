...
describe Puppet::Type.type(:dsc_xadcscertificationauthority) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xadcscertificationauthority[:dsc_ensure] = 'present'
    expect(dsc_xadcscertificationauthority[:ensure]).to eq(dsc_xadcscertificationauthority.provider.munge_ensure(dsc_xadcscertificationauthority[:dsc_ensure].downcase).to_sym)
  end
