...
describe Puppet::Type.type(:dsc_spsite) do

  let :dsc_spsite do
    Puppet::Type.type(:dsc_spsite).new(
      :name     => 'foo',
      :dsc_url => 'foo',
    )
  end
  ...
  it 'should allow all properties to be specified' do
    expect { Puppet::Type.type(:dsc_spsite).new(
      :name     => 'foo',
      :dsc_url => 'foo',
      :dsc_owneralias => 'foo',
  ...
  it "should stringify normally" do
    expect(dsc_spsite.to_s).to eq("Dsc_spsite[foo]")
  end
  ...
  it 'should not accept array for dsc_url' do
    expect{dsc_spsite[:dsc_url] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_url' do
    expect{dsc_spsite[:dsc_url] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_owneralias' do
    expect{dsc_spsite[:dsc_owneralias] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_contentdatabase' do
    expect{dsc_spsite[:dsc_contentdatabase] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_contentdatabase' do
    expect{dsc_spsite[:dsc_contentdatabase] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_description' do
    expect{dsc_spsite[:dsc_description] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_hostheaderwebapplication' do
    expect{dsc_spsite[:dsc_hostheaderwebapplication] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_hostheaderwebapplication' do
    expect{dsc_spsite[:dsc_hostheaderwebapplication] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_name' do
    expect{dsc_spsite[:dsc_name] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_name' do
    expect{dsc_spsite[:dsc_name] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_owneremail' do
    expect{dsc_spsite[:dsc_owneremail] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_quotatemplate' do
    expect{dsc_spsite[:dsc_quotatemplate] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_quotatemplate' do
    expect{dsc_spsite[:dsc_quotatemplate] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_secondaryemail' do
    expect{dsc_spsite[:dsc_secondaryemail] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_secondaryowneralias' do
    expect{dsc_spsite[:dsc_secondaryowneralias] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_secondaryowneralias' do
    expect{dsc_spsite[:dsc_secondaryowneralias] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_template' do
    expect{dsc_spsite[:dsc_template] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it "should not accept empty password for dsc_installaccount" do
    expect{dsc_spsite[:dsc_installaccount] = {"user"=>"user", "password"=>""}}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_installaccount' do
    expect{dsc_spsite[:dsc_installaccount] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_installaccount' do
    expect{dsc_spsite[:dsc_installaccount] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  describe "powershell provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:powershell).new(dsc_spsite)
    end

    before(:each) do
      @provider = described_class.provider(:powershell).new(dsc_spsite)
    end
