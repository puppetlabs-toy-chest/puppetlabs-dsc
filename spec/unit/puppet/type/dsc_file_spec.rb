...
describe Puppet::Type.type(:dsc_file) do
  ...
  describe "dsc_configuration provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:dsc_configuration).new(dsc_file)
    end
  ...
  describe "mof provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:dsc_mof).new(dsc_file)
    end

    before(:each) do
      @provider = described_class.provider(:dsc_mof).new(dsc_file)
    end
