...
describe Puppet::Type.type(:dsc_xscdpmdatabaseserversetup) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscdpmdatabaseserversetup[:dsc_ensure] = 'present'
    expect(dsc_xscdpmdatabaseserversetup[:ensure]).to eq(dsc_xscdpmdatabaseserversetup.provider.munge_ensure(dsc_xscdpmdatabaseserversetup[:dsc_ensure].downcase).to_sym)
  end
