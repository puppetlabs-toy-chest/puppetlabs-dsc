...
describe Puppet::Type.type(:dsc_xexchexchangecertificate) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xexchexchangecertificate[:dsc_ensure] = 'present'
    expect(dsc_xexchexchangecertificate[:ensure]).to eq(dsc_xexchexchangecertificate.provider.munge_ensure(dsc_xexchexchangecertificate[:dsc_ensure].downcase).to_sym)
  end
