...
describe Puppet::Type.type(:dsc_xscommanagementserverupdate) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscommanagementserverupdate[:dsc_ensure] = 'present'
    expect(dsc_xscommanagementserverupdate[:ensure]).to eq(dsc_xscommanagementserverupdate.provider.munge_ensure(dsc_xscommanagementserverupdate[:dsc_ensure].downcase).to_sym)
  end
