...
describe Puppet::Type.type(:dsc_xgroup) do
  ...
  describe "dsc_configuration provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:dsc_configuration).new(dsc_xgroup)
    end

    before(:each) do
      @provider = described_class.provider(:dsc_configuration).new(dsc_xgroup)
    end
  ...
  describe "mof provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:dsc_mof).new(dsc_xgroup)
    end

    before(:each) do
      @provider = described_class.provider(:dsc_mof).new(dsc_xgroup)
    end
