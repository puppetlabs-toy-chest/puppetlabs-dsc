...
describe Puppet::Type.type(:dsc_xazuresqldatabaseserverfirewallrule) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xazuresqldatabaseserverfirewallrule[:dsc_ensure] = 'present'
    expect(dsc_xazuresqldatabaseserverfirewallrule[:ensure]).to eq(dsc_xazuresqldatabaseserverfirewallrule.provider.munge_ensure(dsc_xazuresqldatabaseserverfirewallrule[:dsc_ensure].downcase).to_sym)
  end
