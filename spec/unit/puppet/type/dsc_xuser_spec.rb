...
describe Puppet::Type.type(:dsc_xuser) do

  let :dsc_xuser do
    Puppet::Type.type(:dsc_xuser).new(
      :name     => 'foo',
      :dsc_username => 'foo',
    )
  end
  ...
  it 'should allow all properties to be specified' do
    expect { Puppet::Type.type(:dsc_xuser).new(
      :name     => 'foo',
      :dsc_username => 'foo',
      :dsc_ensure => 'Present',
      :dsc_fullname => 'foo',
  ...
  it "should stringify normally" do
    expect(dsc_xuser.to_s).to eq("Dsc_xuser[foo]")
  end

  it 'should default to ensure => present' do
    expect(dsc_xuser[:ensure]).to eq :present
  end

  it 'should require that dsc_username is specified' do
    #dsc_xuser[:dsc_username]
    expect { Puppet::Type.type(:dsc_xuser).new(
      :name     => 'foo',
  ...
  it 'should not accept array for dsc_username' do
    expect{dsc_xuser[:dsc_username] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_username' do
    expect{dsc_xuser[:dsc_username] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xuser[:dsc_ensure] = 'present'
    expect(dsc_xuser[:ensure]).to eq(dsc_xuser[:dsc_ensure].downcase.to_sym)
  end

  it 'should accept dsc_ensure predefined value Absent' do
    dsc_xuser[:dsc_ensure] = 'Absent'
    expect(dsc_xuser[:dsc_ensure]).to eq('Absent')
  end
  ...
  it 'should not accept values not equal to predefined values' do
    expect{dsc_xuser[:dsc_ensure] = 'invalid value'}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_ensure' do
    expect{dsc_xuser[:dsc_ensure] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_ensure' do
    expect{dsc_xuser[:dsc_ensure] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_fullname' do
    expect{dsc_xuser[:dsc_fullname] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_description' do
    expect{dsc_xuser[:dsc_description] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it "should not accept empty password for dsc_password" do
    expect{dsc_xuser[:dsc_password] = {"user"=>"user", "password"=>""}}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_password' do
    expect{dsc_xuser[:dsc_password] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_password' do
    expect{dsc_xuser[:dsc_password] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  describe "powershell provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:powershell).new(dsc_xuser)
    end

    before(:each) do
      @provider = described_class.provider(:powershell).new(dsc_xuser)
    end
    ...
    describe "when dsc_ensure is 'present'" do
      ...
      before(:each) do
        dsc_xuser.original_parameters[:dsc_ensure] = 'present'
        dsc_xuser[:dsc_ensure] = 'present'
        @provider = described_class.provider(:powershell).new(dsc_xuser)
      end
    ...
    describe "when dsc_ensure is 'absent'" do
      ...
      before(:each) do
        dsc_xuser.original_parameters[:dsc_ensure] = 'absent'
        dsc_xuser[:dsc_ensure] = 'absent'
        @provider = described_class.provider(:powershell).new(dsc_xuser)
      end

      it "should update :ensure to :absent" do
        expect(dsc_xuser[:ensure]).to eq(:absent)
      end
