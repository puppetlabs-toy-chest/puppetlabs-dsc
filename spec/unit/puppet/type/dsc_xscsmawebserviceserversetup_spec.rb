...
describe Puppet::Type.type(:dsc_xscsmawebserviceserversetup) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscsmawebserviceserversetup[:dsc_ensure] = 'present'
    expect(dsc_xscsmawebserviceserversetup[:ensure]).to eq(dsc_xscsmawebserviceserversetup.provider.munge_ensure(dsc_xscsmawebserviceserversetup[:dsc_ensure].downcase).to_sym)
  end
