...
describe Puppet::Type.type(:dsc_xscsmarunbookworkerserversetup) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscsmarunbookworkerserversetup[:dsc_ensure] = 'present'
    expect(dsc_xscsmarunbookworkerserversetup[:ensure]).to eq(dsc_xscsmarunbookworkerserversetup.provider.munge_ensure(dsc_xscsmarunbookworkerserversetup[:dsc_ensure].downcase).to_sym)
  end
