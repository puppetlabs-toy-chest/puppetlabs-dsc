...
describe Puppet::Type.type(:dsc_xexchpowershellvirtualdirectory) do
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_allowservicerestart" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_allowservicerestart]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_allowservicerestart" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_allowservicerestart]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_basicauthentication" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_basicauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_basicauthentication" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_basicauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_certificateauthentication" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_certificateauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_certificateauthentication" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_certificateauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_requiressl" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_requiressl]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_requiressl" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_requiressl]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
  ...
  it "should accept boolean-like value 'true' and munge this value to boolean for dsc_windowsauthentication" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_windowsauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('true'))
  end
  ...
  it "should accept boolean-like value 'false' and munge this value to boolean for dsc_windowsauthentication" do
    ...
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_windowsauthentication]).to eq(PuppetX::Dsc::TypeHelpers.munge_boolean('false'))
  end
