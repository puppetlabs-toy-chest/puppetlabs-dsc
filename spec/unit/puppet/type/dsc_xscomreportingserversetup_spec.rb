...
describe Puppet::Type.type(:dsc_xscomreportingserversetup) do
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_xscomreportingserversetup[:dsc_ensure] = 'present'
    expect(dsc_xscomreportingserversetup[:ensure]).to eq(dsc_xscomreportingserversetup.provider.munge_ensure(dsc_xscomreportingserversetup[:dsc_ensure].downcase).to_sym)
  end
