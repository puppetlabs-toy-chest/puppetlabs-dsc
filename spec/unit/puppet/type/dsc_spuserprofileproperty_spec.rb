...
describe Puppet::Type.type(:dsc_spuserprofileproperty) do

  let :dsc_spuserprofileproperty do
    Puppet::Type.type(:dsc_spuserprofileproperty).new(
      :name     => 'foo',
      :dsc_name => 'foo',
    )
  end
  ...
  it 'should allow all properties to be specified' do
    expect { Puppet::Type.type(:dsc_spuserprofileproperty).new(
      :name     => 'foo',
      :dsc_name => 'foo',
      :dsc_ensure => 'Present',
  ...
  it "should stringify normally" do
    expect(dsc_spuserprofileproperty.to_s).to eq("Dsc_spuserprofileproperty[foo]")
  end

  it 'should default to ensure => present' do
    expect(dsc_spuserprofileproperty[:ensure]).to eq :present
  end

  it 'should require that dsc_name is specified' do
    #dsc_spuserprofileproperty[:dsc_name]
    expect { Puppet::Type.type(:dsc_spuserprofileproperty).new(
      :name     => 'foo',
  ...
  it 'should not accept array for dsc_name' do
    expect{dsc_spuserprofileproperty[:dsc_name] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_name' do
    expect{dsc_spuserprofileproperty[:dsc_name] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should accept dsc_ensure predefined value present and update ensure with this value (ensure end value should be a symbol)' do
    dsc_spuserprofileproperty[:dsc_ensure] = 'present'
    expect(dsc_spuserprofileproperty[:ensure]).to eq(dsc_spuserprofileproperty[:dsc_ensure].downcase.to_sym)
  end

  it 'should accept dsc_ensure predefined value Absent' do
    dsc_spuserprofileproperty[:dsc_ensure] = 'Absent'
    expect(dsc_spuserprofileproperty[:dsc_ensure]).to eq('Absent')
  end
  ...
  it 'should not accept values not equal to predefined values' do
    expect{dsc_spuserprofileproperty[:dsc_ensure] = 'invalid value'}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_ensure' do
    expect{dsc_spuserprofileproperty[:dsc_ensure] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_ensure' do
    expect{dsc_spuserprofileproperty[:dsc_ensure] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_userprofileservice' do
    expect{dsc_spuserprofileproperty[:dsc_userprofileservice] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_displayname' do
    expect{dsc_spuserprofileproperty[:dsc_displayname] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should accept dsc_type predefined value BigInteger' do
    dsc_spuserprofileproperty[:dsc_type] = 'BigInteger'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('BigInteger')
  end
  ...
  it 'should accept dsc_type predefined value Binary' do
    dsc_spuserprofileproperty[:dsc_type] = 'Binary'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('Binary')
  end
  ...
  it 'should accept dsc_type predefined value Boolean' do
    dsc_spuserprofileproperty[:dsc_type] = 'Boolean'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('Boolean')
  end
  ...
  it 'should accept dsc_type predefined value Date' do
    dsc_spuserprofileproperty[:dsc_type] = 'Date'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('Date')
  end
  ...
  it 'should accept dsc_type predefined value DateNoYear' do
    dsc_spuserprofileproperty[:dsc_type] = 'DateNoYear'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('DateNoYear')
  end
  ...
  it 'should accept dsc_type predefined value DateTime' do
    dsc_spuserprofileproperty[:dsc_type] = 'DateTime'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('DateTime')
  end
  ...
  it 'should accept dsc_type predefined value Email' do
    dsc_spuserprofileproperty[:dsc_type] = 'Email'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('Email')
  end
  ...
  it 'should accept dsc_type predefined value Float' do
    dsc_spuserprofileproperty[:dsc_type] = 'Float'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('Float')
  end
  ...
  it 'should accept dsc_type predefined value Guid' do
    dsc_spuserprofileproperty[:dsc_type] = 'Guid'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('Guid')
  end
  ...
  it 'should accept dsc_type predefined value HTML' do
    dsc_spuserprofileproperty[:dsc_type] = 'HTML'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('HTML')
  end
  ...
  it 'should accept dsc_type predefined value Integer' do
    dsc_spuserprofileproperty[:dsc_type] = 'Integer'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('Integer')
  end
  ...
  it 'should accept dsc_type predefined value Person' do
    dsc_spuserprofileproperty[:dsc_type] = 'Person'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('Person')
  end
  ...
  it 'should accept dsc_type predefined value String' do
    dsc_spuserprofileproperty[:dsc_type] = 'String'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('String')
  end
  ...
  it 'should accept dsc_type predefined value StringMultiValue' do
    dsc_spuserprofileproperty[:dsc_type] = 'StringMultiValue'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('StringMultiValue')
  end
  ...
  it 'should accept dsc_type predefined value TimeZone' do
    dsc_spuserprofileproperty[:dsc_type] = 'TimeZone'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('TimeZone')
  end
  ...
  it 'should accept dsc_type predefined value URL' do
    dsc_spuserprofileproperty[:dsc_type] = 'URL'
    expect(dsc_spuserprofileproperty[:dsc_type]).to eq('URL')
  end
  ...
  it 'should not accept values not equal to predefined values' do
    expect{dsc_spuserprofileproperty[:dsc_type] = 'invalid value'}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_type' do
    expect{dsc_spuserprofileproperty[:dsc_type] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_type' do
    expect{dsc_spuserprofileproperty[:dsc_type] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_description' do
    expect{dsc_spuserprofileproperty[:dsc_description] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should accept dsc_policysetting predefined value Mandatory' do
    dsc_spuserprofileproperty[:dsc_policysetting] = 'Mandatory'
    expect(dsc_spuserprofileproperty[:dsc_policysetting]).to eq('Mandatory')
  end
  ...
  it 'should accept dsc_policysetting predefined value Optin' do
    dsc_spuserprofileproperty[:dsc_policysetting] = 'Optin'
    expect(dsc_spuserprofileproperty[:dsc_policysetting]).to eq('Optin')
  end
  ...
  it 'should accept dsc_policysetting predefined value Optout' do
    dsc_spuserprofileproperty[:dsc_policysetting] = 'Optout'
    expect(dsc_spuserprofileproperty[:dsc_policysetting]).to eq('Optout')
  end
  ...
  it 'should accept dsc_policysetting predefined value Disabled' do
    dsc_spuserprofileproperty[:dsc_policysetting] = 'Disabled'
    expect(dsc_spuserprofileproperty[:dsc_policysetting]).to eq('Disabled')
  end
  ...
  it 'should not accept values not equal to predefined values' do
    expect{dsc_spuserprofileproperty[:dsc_policysetting] = 'invalid value'}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_policysetting' do
    expect{dsc_spuserprofileproperty[:dsc_policysetting] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_policysetting' do
    expect{dsc_spuserprofileproperty[:dsc_policysetting] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should accept dsc_privacysetting predefined value Public' do
    dsc_spuserprofileproperty[:dsc_privacysetting] = 'Public'
    expect(dsc_spuserprofileproperty[:dsc_privacysetting]).to eq('Public')
  end
  ...
  it 'should accept dsc_privacysetting predefined value Contacts' do
    dsc_spuserprofileproperty[:dsc_privacysetting] = 'Contacts'
    expect(dsc_spuserprofileproperty[:dsc_privacysetting]).to eq('Contacts')
  end
  ...
  it 'should accept dsc_privacysetting predefined value Organization' do
    dsc_spuserprofileproperty[:dsc_privacysetting] = 'Organization'
    expect(dsc_spuserprofileproperty[:dsc_privacysetting]).to eq('Organization')
  end
  ...
  it 'should accept dsc_privacysetting predefined value Manager' do
    dsc_spuserprofileproperty[:dsc_privacysetting] = 'Manager'
    expect(dsc_spuserprofileproperty[:dsc_privacysetting]).to eq('Manager')
  end
  ...
  it 'should accept dsc_privacysetting predefined value Private' do
    dsc_spuserprofileproperty[:dsc_privacysetting] = 'Private'
    expect(dsc_spuserprofileproperty[:dsc_privacysetting]).to eq('Private')
  end
  ...
  it 'should not accept values not equal to predefined values' do
    expect{dsc_spuserprofileproperty[:dsc_privacysetting] = 'invalid value'}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_privacysetting' do
    expect{dsc_spuserprofileproperty[:dsc_privacysetting] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_privacysetting' do
    expect{dsc_spuserprofileproperty[:dsc_privacysetting] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_mappingconnectionname' do
    expect{dsc_spuserprofileproperty[:dsc_mappingconnectionname] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_mappingpropertyname' do
    expect{dsc_spuserprofileproperty[:dsc_mappingpropertyname] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_mappingpropertyname' do
    expect{dsc_spuserprofileproperty[:dsc_mappingpropertyname] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_mappingdirection' do
    expect{dsc_spuserprofileproperty[:dsc_mappingdirection] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_termstore' do
    expect{dsc_spuserprofileproperty[:dsc_termstore] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept array for dsc_termgroup' do
    expect{dsc_spuserprofileproperty[:dsc_termgroup] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_termgroup' do
    expect{dsc_spuserprofileproperty[:dsc_termgroup] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it 'should not accept boolean for dsc_termset' do
    expect{dsc_spuserprofileproperty[:dsc_termset] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  it "should not accept empty password for dsc_installaccount" do
    expect{dsc_spuserprofileproperty[:dsc_installaccount] = {"user"=>"user", "password"=>""}}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept array for dsc_installaccount' do
    expect{dsc_spuserprofileproperty[:dsc_installaccount] = ["foo", "bar", "spec"]}.to raise_error(Puppet::ResourceError)
  end

  it 'should not accept boolean for dsc_installaccount' do
    expect{dsc_spuserprofileproperty[:dsc_installaccount] = true}.to raise_error(Puppet::ResourceError)
  end
  ...
  describe "powershell provider tests" do
    ...
    it "should successfully instanciate the provider" do
      described_class.provider(:powershell).new(dsc_spuserprofileproperty)
    end

    before(:each) do
      @provider = described_class.provider(:powershell).new(dsc_spuserprofileproperty)
    end
    ...
    describe "when dsc_ensure is 'present'" do
      ...
      before(:each) do
        dsc_spuserprofileproperty.original_parameters[:dsc_ensure] = 'present'
        dsc_spuserprofileproperty[:dsc_ensure] = 'present'
        @provider = described_class.provider(:powershell).new(dsc_spuserprofileproperty)
      end
    ...
    describe "when dsc_ensure is 'absent'" do
      ...
      before(:each) do
        dsc_spuserprofileproperty.original_parameters[:dsc_ensure] = 'absent'
        dsc_spuserprofileproperty[:dsc_ensure] = 'absent'
        @provider = described_class.provider(:powershell).new(dsc_spuserprofileproperty)
      end

      it "should update :ensure to :absent" do
        expect(dsc_spuserprofileproperty[:ensure]).to eq(:absent)
      end
