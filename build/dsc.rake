...
eod
    ...
    task :import, [:dsc_resources_path] do |t, args|
      ...
      if (dsc_resources_path == default_dsc_resources_path)
      ...
      FileUtils.cp_r "#{dsc_resources_path_tmp}/.", vendor_dsc_resources_path, :remove_destination => true
      FileUtils.cp_r "#{dsc_resources_path_tmp}/.", dsc_resources_path
      FileUtils.rm_rf "#{vendor_dsc_resources_path}/PSDesiredStateConfiguration"
