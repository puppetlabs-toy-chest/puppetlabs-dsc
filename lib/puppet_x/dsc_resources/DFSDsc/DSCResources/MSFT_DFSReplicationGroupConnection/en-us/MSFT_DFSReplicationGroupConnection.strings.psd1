ConvertFrom-StringData @'
    GettingReplicationGroupConnectionMessage                  = Getting DFS Replication Group Connection "{0}" from "{1}" to "{2}".
    ...
    SettingReplicationGroupConnectionMessage                  = Setting DFS Replication Group Connection "{0}" from "{1}" to "{2}".
    ...
    TestingReplicationGroupConnectionMessage                  = Testing DFS Replication Group Connection "{0}" from "{1}" to "{2}".
    ReplicationGroupConnectionNeedsUpdateMessage              = DFS Replication Group Connection "{0}" from "{1}" to "{2}" {3} is different. Change required.
