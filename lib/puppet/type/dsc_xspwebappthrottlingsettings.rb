...
Puppet::Type.newtype(:dsc_xspwebappthrottlingsettings) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'

    class PuppetX::Dsc::TypeHelpers
      def self.validate_MSFT_xSPWebApplicationHappyHour(mof_type_map, name, value)
        required = []
        ...
        lowkey_hash.keys.each do |key|
          if lowkey_hash[key]
            validate_mof_type(mof_type_map[key], 'MSFT_xSPWebApplicationHappyHour', key, lowkey_hash[key])
          end
        end
      end
    end
  ...
  @doc = %q{
    The DSC xSPWebAppThrottlingSettings resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPWebAppThrottlingSettings/MSFT_xSPWebAppThrottlingSettings.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPWebAppThrottlingSettings' end
  def dscmeta_resource_name; 'MSFT_xSPWebAppThrottlingSettings' end
  ...
  # Name:         HappyHour
  # Type:         MSFT_xSPWebApplicationHappyHour
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_happyhour) do
    def mof_type; 'MSFT_xSPWebApplicationHappyHour' end
    ...
    validate do |value|
      ...
      PuppetX::Dsc::TypeHelpers.validate_MSFT_xSPWebApplicationHappyHour(mof_type_map, "HappyHour", value)
    end
    munge do |value|
...
Puppet::Type.type(:dsc_xspwebappthrottlingsettings).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
