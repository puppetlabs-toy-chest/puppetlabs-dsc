...
Puppet::Type.newtype(:dsc_xspwordautomationserviceapp) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPWordAutomationServiceApp resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPWordAutomationServiceApp/MSFT_xSPWordAutomationServiceApp.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPWordAutomationServiceApp' end
  def dscmeta_resource_name; 'MSFT_xSPWordAutomationServiceApp' end
...
Puppet::Type.type(:dsc_xspwordautomationserviceapp).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
