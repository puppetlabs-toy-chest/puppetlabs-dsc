...
Puppet::Type.newtype(:dsc_xscomreportingserversetup) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCOMReportingServerSetup')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSCOMReportingServerSetup'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCOMReportingServerSetup')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSCOMReportingServerSetup'
    end
