...
Puppet::Type.newtype(:dsc_xblautobitlocker) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xBLAutoBitlocker')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xBLAutoBitlocker'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xBLAutoBitlocker')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xBLAutoBitlocker'
    end
  ...
  newparam(:dscmeta_module_name) do
    ...
    validate do |value|
      fail 'dscmeta_module_name is read-only' if value != 'xBitlocker'
    end
