...
Puppet::Type.newtype(:dsc_xspalternateurl) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPAlternateUrl resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPAlternateUrl/MSFT_xSPAlternateUrl.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPAlternateUrl' end
  def dscmeta_resource_name; 'MSFT_xSPAlternateUrl' end
...
Puppet::Type.type(:dsc_xspalternateurl).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
