...
Puppet::Type.newtype(:dsc_xazurepackidentityprovider) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xAzurePackIdentityProvider')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xAzurePackIdentityProvider'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xAzurePackIdentityProvider')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xAzurePackIdentityProvider'
    end
