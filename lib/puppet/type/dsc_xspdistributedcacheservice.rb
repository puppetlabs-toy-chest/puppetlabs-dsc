...
Puppet::Type.newtype(:dsc_xspdistributedcacheservice) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSPDistributedCacheService')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSPDistributedCacheService'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSPDistributedCacheService')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSPDistributedCacheService'
    end
