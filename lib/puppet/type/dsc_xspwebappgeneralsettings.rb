...
Puppet::Type.newtype(:dsc_xspwebappgeneralsettings) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPWebAppGeneralSettings resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPWebAppGeneralSettings/MSFT_xSPWebAppGeneralSettings.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPWebAppGeneralSettings' end
  def dscmeta_resource_name; 'MSFT_xSPWebAppGeneralSettings' end
...
Puppet::Type.type(:dsc_xspwebappgeneralsettings).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
