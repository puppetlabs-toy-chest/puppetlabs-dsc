...
Puppet::Type.newtype(:dsc_xwebpackagedeploy) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    ...
    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xWebPackageDeploy'
    end
  ...
  newparam(:dscmeta_resource_name) do
    ...
    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'xWebPackageDeploy'
    end
  ...
  newparam(:dscmeta_module_name) do
    ...
    validate do |value|
      fail 'dscmeta_module_name is read-only' if value != 'xWebDeploy'
    end
