...
Puppet::Type.newtype(:dsc_xspinstall) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSPInstall')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSPInstall'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSPInstall')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSPInstall'
    end
