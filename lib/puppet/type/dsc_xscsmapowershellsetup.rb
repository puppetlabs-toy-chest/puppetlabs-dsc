...
Puppet::Type.newtype(:dsc_xscsmapowershellsetup) do
  ...
  newproperty(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCSMAPowerShellSetup')."
  ...
  newproperty(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCSMAPowerShellSetup')."

    def retrieve
      'MSFT_xSCSMAPowerShellSetup'
    end
