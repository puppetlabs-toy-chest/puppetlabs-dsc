...
Puppet::Type.newtype(:dsc_xexchpopsettings) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xExchPopSettings')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchPopSettings'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xExchPopSettings')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchPopSettings'
    end
