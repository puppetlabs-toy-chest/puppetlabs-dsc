...
Puppet::Type.newtype(:dsc_xwebconfigkeyvalue) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xWebConfigKeyValue')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xWebConfigKeyValue'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xWebConfigKeyValue')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xWebConfigKeyValue'
    end
