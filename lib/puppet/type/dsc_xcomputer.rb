...
Puppet::Type.newtype(:dsc_xcomputer) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    ...
    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xComputer'
    end
  ...
  newparam(:dscmeta_resource_name) do
    ...
    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xComputer'
    end
  ...
  newparam(:dscmeta_module_name) do
    ...
    validate do |value|
      fail 'dscmeta_module_name is read-only' if value != 'xComputerManagement'
    end
  ...
  newparam(:dscmeta_module_version) do
    ...
    validate do |value|
      fail 'dscmeta_module_version is read-only' if value != '1.3.0'
    end
