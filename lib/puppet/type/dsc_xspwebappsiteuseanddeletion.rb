...
Puppet::Type.newtype(:dsc_xspwebappsiteuseanddeletion) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPWebAppSiteUseAndDeletion resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPWebAppSiteUseAndDeletion/MSFT_xSPWebAppSiteUseAndDeletion.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPWebAppSiteUseAndDeletion' end
  def dscmeta_resource_name; 'MSFT_xSPWebAppSiteUseAndDeletion' end
...
Puppet::Type.type(:dsc_xspwebappsiteuseanddeletion).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
