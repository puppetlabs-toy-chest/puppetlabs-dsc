...
Puppet::Type.newtype(:dsc_xjeatoolkit) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xJeaToolKit')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xJeaToolKit'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xJeaToolkit')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xJeaToolkit'
    end
