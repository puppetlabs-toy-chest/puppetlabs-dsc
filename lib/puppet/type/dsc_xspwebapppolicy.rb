...
Puppet::Type.newtype(:dsc_xspwebapppolicy) do
  ...
  @doc = %q{
    ...
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPWebAppPolicy/MSFT_xSPWebAppPolicy.schema.mof'
  ...
  def dscmeta_resource_name; 'MSFT_xSPWebAppPolicy' end
...
Puppet::Type.type(:dsc_xspwebapppolicy).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
