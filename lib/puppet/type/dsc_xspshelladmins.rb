...
Puppet::Type.newtype(:dsc_xspshelladmins) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'

    class PuppetX::Dsc::TypeHelpers
      def self.validate_MSFT_xSPContentDatabasePermissions(mof_type_map, name, value)
        required = []
        ...
        lowkey_hash.keys.each do |key|
          if lowkey_hash[key]
            validate_mof_type(mof_type_map[key], 'MSFT_xSPContentDatabasePermissions', key, lowkey_hash[key])
          end
        end
      end
    end
  ...
  @doc = %q{
    The DSC xSPShellAdmins resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPShellAdmins/MSFT_xSPShellAdmins.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPShellAdmins' end
  def dscmeta_resource_name; 'MSFT_xSPShellAdmins' end
  ...
  # Type:         MSFT_xSPContentDatabasePermissions[]
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_contentdatabases, :array_matching => :all) do
    def mof_type; 'MSFT_xSPContentDatabasePermissions[]' end
    ...
    validate do |value|
      ...
      (value.kind_of?(Hash) ? [value] : value).each_with_index do |v, i|
        ...
        PuppetX::Dsc::TypeHelpers.validate_MSFT_xSPContentDatabasePermissions(mof_type_map, "ContentDatabases", v)
      end
    end
    munge do |value|
      value.kind_of?(Hash) ?
...
Puppet::Type.type(:dsc_xspshelladmins).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
