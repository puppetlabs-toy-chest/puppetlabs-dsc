...
Puppet::Type.newtype(:dsc_xexchdatabaseavailabilitygroupmember) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xExchDatabaseAvailabilityGroupMember')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchDatabaseAvailabilityGroupMember'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xExchDatabaseAvailabilityGroupMember')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchDatabaseAvailabilityGroupMember'
    end
