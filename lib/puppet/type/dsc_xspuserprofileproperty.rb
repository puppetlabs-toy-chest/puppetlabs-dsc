...
Puppet::Type.newtype(:dsc_xspuserprofileproperty) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPUserProfileProperty resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPUserProfileProperty/MSFT_xSPUserProfileProperty.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPUserProfileProperty' end
  def dscmeta_resource_name; 'MSFT_xSPUserProfileProperty' end
...
Puppet::Type.type(:dsc_xspuserprofileproperty).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
