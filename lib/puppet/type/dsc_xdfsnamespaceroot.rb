...
Puppet::Type.newtype(:dsc_xdfsnamespaceroot) do
  ...
  newparam(:dsc_referralpriorityrank) do
    ...
    validate do |value|
      PuppetX::Dsc::TypeHelpers.validate_type_value(mof_type, value, "ReferralPriorityRank")
    end
    munge do |value|
  ...
  newparam(:dsc_timetolivesec) do
    ...
    validate do |value|
      PuppetX::Dsc::TypeHelpers.validate_type_value(mof_type, value, "TimeToLiveSec")
    end
    munge do |value|
      PuppetX::Dsc::TypeHelpers.munge_integer(value)
    end
