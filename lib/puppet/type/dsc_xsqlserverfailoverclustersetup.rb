...
Puppet::Type.newtype(:dsc_xsqlserverfailoverclustersetup) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSQLServerFailoverClusterSetup')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSQLServerFailoverClusterSetup'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSQLServerFailoverClusterSetup')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSQLServerFailoverClusterSetup'
    end
