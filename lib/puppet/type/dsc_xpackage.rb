...
Puppet::Type.newtype(:dsc_xpackage) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xPackage')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xPackage'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xPackageResource')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xPackageResource'
    end
