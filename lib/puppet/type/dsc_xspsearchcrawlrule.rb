...
Puppet::Type.newtype(:dsc_xspsearchcrawlrule) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPSearchCrawlRule resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPSearchCrawlRule/MSFT_xSPSearchCrawlRule.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPSearchCrawlRule' end
  def dscmeta_resource_name; 'MSFT_xSPSearchCrawlRule' end
...
Puppet::Type.type(:dsc_xspsearchcrawlrule).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
