...
Puppet::Type.newtype(:dsc_xspexcelserviceapp) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPExcelServiceApp resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPExcelServiceApp/MSFT_xSPExcelServiceApp.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPExcelServiceApp' end
  def dscmeta_resource_name; 'MSFT_xSPExcelServiceApp' end
...
Puppet::Type.type(:dsc_xspexcelserviceapp).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
