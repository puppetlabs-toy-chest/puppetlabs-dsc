...
Puppet::Type.newtype(:dsc_xsptimerjobstate) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPTimerJobState resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPTimerJobState/MSFT_xSPTimerJobState.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPTimerJobState' end
  def dscmeta_resource_name; 'MSFT_xSPTimerJobState' end
...
Puppet::Type.type(:dsc_xsptimerjobstate).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
