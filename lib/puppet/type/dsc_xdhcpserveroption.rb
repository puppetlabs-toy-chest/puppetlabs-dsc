...
Puppet::Type.newtype(:dsc_xdhcpserveroption) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xDhcpServerOption')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xDhcpServerOption'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xDhcpServerOption')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xDhcpServerOption'
    end
