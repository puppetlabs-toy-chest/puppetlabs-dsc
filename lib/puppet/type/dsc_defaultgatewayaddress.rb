...
Puppet::Type.newtype(:dsc_defaultgatewayaddress) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC DefaultGatewayAddress resource type.
    Automatically generated from
    'NetworkingDsc/DSCResources/MSFT_DefaultGatewayAddress/MSFT_DefaultGatewayAddress.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DefaultGatewayAddress' end
  def dscmeta_resource_name; 'MSFT_DefaultGatewayAddress' end
...
Puppet::Type.type(:dsc_defaultgatewayaddress).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
