...
Puppet::Type.newtype(:dsc_dhcpscopeoptionvalue) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC DhcpScopeOptionValue resource type.
    Automatically generated from
    'xDhcpServer/DSCResources/MSFT_DhcpScopeOptionValue/MSFT_DhcpScopeOptionValue.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DhcpScopeOptionValue' end
  def dscmeta_resource_name; 'MSFT_DhcpScopeOptionValue' end
  ...
  newparam(:dsc_scopeid) do
    ...
    desc "ScopeId - Scope ID to set the option."
    isrequired
    validate do |value|
...
Puppet::Type.type(:dsc_dhcpscopeoptionvalue).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
