...
Puppet::Type.newtype(:dsc_xexchumservice) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xExchUMService')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchUMService'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xExchUMService')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchUMService'
    end
