...
Puppet::Type.newtype(:dsc_xspoutgoingemailsettings) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPOutgoingEmailSettings resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPOutgoingEmailSettings/MSFT_xSPOutgoingEmailSettings.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPOutgoingEmailSettings' end
  def dscmeta_resource_name; 'MSFT_xSPOutgoingEmailSettings' end
...
Puppet::Type.type(:dsc_xspoutgoingemailsettings).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
