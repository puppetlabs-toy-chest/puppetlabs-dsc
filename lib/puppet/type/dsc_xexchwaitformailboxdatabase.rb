...
Puppet::Type.newtype(:dsc_xexchwaitformailboxdatabase) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xExchWaitForMailboxDatabase')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchWaitForMailboxDatabase'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xExchWaitForMailboxDatabase')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchWaitForMailboxDatabase'
    end
