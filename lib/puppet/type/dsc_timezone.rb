...
Puppet::Type.newtype(:dsc_timezone) do
  ...
  @doc = %q{
    ...
    'ComputerManagementDsc/DSCResources/MSFT_TimeZone/MSFT_TimeZone.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'TimeZone' end
  def dscmeta_resource_name; 'MSFT_TimeZone' end
...
Puppet::Type.type(:dsc_timezone).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
