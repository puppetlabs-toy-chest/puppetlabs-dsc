...
Puppet::Type.newtype(:dsc_dnsserveraddress) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC DnsServerAddress resource type.
    Automatically generated from
    'NetworkingDsc/DSCResources/MSFT_DnsServerAddress/MSFT_DnsServerAddress.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DnsServerAddress' end
  def dscmeta_resource_name; 'MSFT_DnsServerAddress' end
...
Puppet::Type.type(:dsc_dnsserveraddress).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
