...
Puppet::Type.newtype(:dsc_xspuserprofilesyncconnection) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPUserProfileSyncConnection resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPUserProfileSyncConnection/MSFT_xSPUserProfileSyncConnection.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPUserProfileSyncConnection' end
  def dscmeta_resource_name; 'MSFT_xSPUserProfileSyncConnection' end
...
Puppet::Type.type(:dsc_xspuserprofilesyncconnection).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
