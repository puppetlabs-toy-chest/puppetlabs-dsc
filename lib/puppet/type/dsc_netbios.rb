...
Puppet::Type.newtype(:dsc_netbios) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC NetBios resource type.
    Automatically generated from
    'NetworkingDsc/DSCResources/MSFT_NetBios/MSFT_NetBios.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'NetBios' end
  def dscmeta_resource_name; 'MSFT_NetBios' end
...
Puppet::Type.type(:dsc_netbios).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
