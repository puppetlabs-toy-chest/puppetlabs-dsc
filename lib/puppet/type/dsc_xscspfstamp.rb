...
Puppet::Type.newtype(:dsc_xscspfstamp) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCSPFStamp')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSCSPFStamp'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCSPFStamp')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSCSPFStamp'
    end
