...
Puppet::Type.newtype(:dsc_xscspfserverupdate) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCSPFServerUpdate')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSCSPFServerUpdate'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCSPFServerUpdate')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSCSPFServerUpdate'
    end
