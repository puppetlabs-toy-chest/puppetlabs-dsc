...
Puppet::Type.newtype(:dsc_dhcppolicyoptionvalue) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC DhcpPolicyOptionValue resource type.
    Automatically generated from
    'xDhcpServer/DSCResources/MSFT_DhcpPolicyOptionValue/MSFT_DhcpPolicyOptionValue.schema.mof'
  ...
  validate do
      ...
      fail('dsc_policyname is a required attribute') if self[:dsc_policyname].nil?
  ...
  def dscmeta_resource_friendly_name; 'DhcpPolicyOptionValue' end
  def dscmeta_resource_name; 'MSFT_DhcpPolicyOptionValue' end
  ...
  newparam(:dsc_scopeid) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "ScopeId - Scope ID to get policy values from. Do not use it to get an option from server level."
    validate do |value|
      unless value.kind_of?(String)
        fail("Invalid value '#{value}'. Should be a string")
      end
...
Puppet::Type.type(:dsc_dhcppolicyoptionvalue).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
