...
Puppet::Type.newtype(:dsc_xspserviceapppool) do
  ...
  @doc = %q{
    ...
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPServiceAppPool/MSFT_xSPServiceAppPool.schema.mof'
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSPServiceAppPool')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSPServiceAppPool'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSPServiceAppPool')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSPServiceAppPool'
    end
