...
Puppet::Type.newtype(:dsc_dhcpreservedipoptionvalue) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC DhcpReservedIPOptionValue resource type.
    Automatically generated from
    'xDhcpServer/DSCResources/MSFT_DhcpReservedIPOptionValue/MSFT_DhcpReservedIPOptionValue.schema.mof'
  ...
  validate do
      fail('dsc_reservedip is a required attribute') if self[:dsc_reservedip].nil?
  ...
  def dscmeta_resource_friendly_name; 'DhcpReservedIPOptionValue' end
  def dscmeta_resource_name; 'MSFT_DhcpReservedIPOptionValue' end
  ...
  newparam(:dsc_reservedip) do
    ...
    desc "ReservedIP - Reserved IP to set the option value."
    isrequired
    validate do |value|
...
Puppet::Type.type(:dsc_dhcpreservedipoptionvalue).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
