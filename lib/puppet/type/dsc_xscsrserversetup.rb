...
Puppet::Type.newtype(:dsc_xscsrserversetup) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCSRServerSetup')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSCSRServerSetup'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCSRServerSetup')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSCSRServerSetup'
    end
