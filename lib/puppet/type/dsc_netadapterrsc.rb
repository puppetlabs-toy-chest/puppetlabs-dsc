...
Puppet::Type.newtype(:dsc_netadapterrsc) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC NetAdapterRsc resource type.
    Automatically generated from
    'NetworkingDsc/DSCResources/MSFT_NetAdapterRsc/MSFT_NetAdapterRSC.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'NetAdapterRsc' end
  def dscmeta_resource_name; 'MSFT_NetAdapterRsc' end
...
Puppet::Type.type(:dsc_netadapterrsc).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
