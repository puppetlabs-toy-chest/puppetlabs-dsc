...
Puppet::Type.newtype(:dsc_xexchmapivirtualdirectory) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xExchMapiVirtualDirectory')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchMapiVirtualDirectory'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xExchMapiVirtualDirectory')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchMapiVirtualDirectory'
    end
