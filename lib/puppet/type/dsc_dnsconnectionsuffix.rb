...
Puppet::Type.newtype(:dsc_dnsconnectionsuffix) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC DnsConnectionSuffix resource type.
    Automatically generated from
    'NetworkingDsc/DSCResources/MSFT_DnsConnectionSuffix/MSFT_DnsConnectionSuffix.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DnsConnectionSuffix' end
  def dscmeta_resource_name; 'MSFT_DnsConnectionSuffix' end
...
Puppet::Type.type(:dsc_dnsconnectionsuffix).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
