...
Puppet::Type.newtype(:dsc_dnsclientglobalsetting) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC DnsClientGlobalSetting resource type.
    Automatically generated from
    'NetworkingDsc/DSCResources/MSFT_DnsClientGlobalSetting/MSFT_DnsClientGlobalSetting.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DnsClientGlobalSetting' end
  def dscmeta_resource_name; 'MSFT_DnsClientGlobalSetting' end
...
Puppet::Type.type(:dsc_dnsclientglobalsetting).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
