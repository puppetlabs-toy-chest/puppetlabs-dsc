...
Puppet::Type.newtype(:dsc_xscspfserversetup) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCSPFServerSetup')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSCSPFServerSetup'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCSPFServerSetup')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSCSPFServerSetup'
    end
