...
Puppet::Type.newtype(:dsc_xspwebappblockedfiletypes) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPWebAppBlockedFileTypes resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPWebAppBlockedFileTypes/MSFT_xSPWebAppBlockedFileTypes.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPWebAppBlockedFileTypes' end
  def dscmeta_resource_name; 'MSFT_xSPWebAppBlockedFileTypes' end
...
Puppet::Type.type(:dsc_xspwebappblockedfiletypes).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
