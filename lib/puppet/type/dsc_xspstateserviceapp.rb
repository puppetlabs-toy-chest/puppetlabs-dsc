...
Puppet::Type.newtype(:dsc_xspstateserviceapp) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSPStateServiceApp')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSPStateServiceApp'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSPStateServiceApp')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSPStateServiceApp'
    end
