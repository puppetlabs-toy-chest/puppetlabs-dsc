...
Puppet::Type.newtype(:dsc_xspfarmadministrators) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPFarmAdministrators resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPFarmAdministrators/MSFT_xSPFarmAdministrators.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPFarmAdministrators' end
  def dscmeta_resource_name; 'MSFT_xSPFarmAdministrators' end
...
Puppet::Type.type(:dsc_xspfarmadministrators).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
