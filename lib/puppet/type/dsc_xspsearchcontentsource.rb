...
Puppet::Type.newtype(:dsc_xspsearchcontentsource) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'

    class PuppetX::Dsc::TypeHelpers
      def self.validate_MSFT_xSPSearchCrawlSchedule(mof_type_map, name, value)
        ...
        lowkey_hash.keys.each do |key|
          if lowkey_hash[key]
            validate_mof_type(mof_type_map[key], 'MSFT_xSPSearchCrawlSchedule', key, lowkey_hash[key])
          end
        end
      end
    end
  ...
  @doc = %q{
    The DSC xSPSearchContentSource resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPSearchContentSource/MSFT_xSPSearchContentSource.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPSearchContentSource' end
  def dscmeta_resource_name; 'MSFT_xSPSearchContentSource' end
  ...
  # Type:         MSFT_xSPSearchCrawlSchedule
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_incrementalschedule) do
    def mof_type; 'MSFT_xSPSearchCrawlSchedule' end
    ...
    validate do |value|
      ...
      PuppetX::Dsc::TypeHelpers.validate_MSFT_xSPSearchCrawlSchedule(mof_type_map, "IncrementalSchedule", value)
    end
    munge do |value|
  ...
  newparam(:dsc_fullschedule) do
    ...
    validate do |value|
      ...
      PuppetX::Dsc::TypeHelpers.validate_MSFT_xSPSearchCrawlSchedule(mof_type_map, "FullSchedule", value)
    end
    munge do |value|
      PuppetX::Dsc::TypeHelpers.munge_embeddedinstance(mof_type_map, value)
    end
...
Puppet::Type.type(:dsc_xspsearchcontentsource).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
