...
Puppet::Type.newtype(:dsc_netadapterlso) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC NetAdapterLso resource type.
    Automatically generated from
    'NetworkingDsc/DSCResources/MSFT_NetAdapterLso/MSFT_NetAdapterLso.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'NetAdapterLso' end
  def dscmeta_resource_name; 'MSFT_NetAdapterLso' end
...
Puppet::Type.type(:dsc_netadapterlso).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
