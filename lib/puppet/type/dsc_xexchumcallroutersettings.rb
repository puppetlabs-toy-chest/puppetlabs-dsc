...
Puppet::Type.newtype(:dsc_xexchumcallroutersettings) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    ...
    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchUMCallRouterSettings'
    end
  ...
  newparam(:dscmeta_resource_name) do
    ...
    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchUMCallRouterSettings'
    end
