...
Puppet::Type.newtype(:dsc_spusageapplication) do
  ...
  newparam(:dsc_usagelogcuttime) do
    ...
    validate do |value|
      PuppetX::Dsc::TypeHelpers.validate_type_value(mof_type, value, "UsageLogCutTime")
    end
    munge do |value|
  ...
  newparam(:dsc_usagelogmaxfilesizekb) do
    ...
    validate do |value|
      PuppetX::Dsc::TypeHelpers.validate_type_value(mof_type, value, "UsageLogMaxFileSizeKB")
    end
    munge do |value|
      PuppetX::Dsc::TypeHelpers.munge_integer(value)
    end
  ...
  newparam(:dsc_usagelogmaxspacegb) do
    ...
    validate do |value|
      PuppetX::Dsc::TypeHelpers.validate_type_value(mof_type, value, "UsageLogMaxSpaceGB")
    end
    munge do |value|
      PuppetX::Dsc::TypeHelpers.munge_integer(value)
    end
