...
Puppet::Type.newtype(:dsc_xmysqldatabase) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xMySqlDatabase')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xMySqlDatabase'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xMySqlDatabase')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xMySqlDatabase'
    end
