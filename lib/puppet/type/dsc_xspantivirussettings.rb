...
Puppet::Type.newtype(:dsc_xspantivirussettings) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPAntivirusSettings resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPAntivirusSettings/MSFT_xSPAntivirusSettings.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPAntivirusSettings' end
  def dscmeta_resource_name; 'MSFT_xSPAntivirusSettings' end
...
Puppet::Type.type(:dsc_xspantivirussettings).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
