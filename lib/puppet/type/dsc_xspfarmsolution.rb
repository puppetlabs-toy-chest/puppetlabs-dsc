...
Puppet::Type.newtype(:dsc_xspfarmsolution) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPFarmSolution resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPFarmSolution/MSFT_xSPFarmSolution.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPFarmSolution' end
  def dscmeta_resource_name; 'MSFT_xSPFarmSolution' end
...
Puppet::Type.type(:dsc_xspfarmsolution).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
