...
Puppet::Type.newtype(:dsc_xscdpmdatabaseserversetup) do
  ...
  newproperty(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCDPMDatabaseServerSetup')."
  ...
  newproperty(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCDPMDatabaseServerSetup')."
