...
Puppet::Type.newtype(:dsc_xspdesignersettings) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPDesignerSettings resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPDesignerSettings/MSFT_xSPDesignerSettings.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPDesignerSettings' end
  def dscmeta_resource_name; 'MSFT_xSPDesignerSettings' end
...
Puppet::Type.type(:dsc_xspdesignersettings).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
