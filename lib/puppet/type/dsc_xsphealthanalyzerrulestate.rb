...
Puppet::Type.newtype(:dsc_xsphealthanalyzerrulestate) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPHealthAnalyzerRuleState resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPHealthAnalyzerRuleState/MSFT_xSPHealthAnalyzerRuleState.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPHealthAnalyzerRuleState' end
  def dscmeta_resource_name; 'MSFT_xSPHealthAnalyzerRuleState' end
...
Puppet::Type.type(:dsc_xsphealthanalyzerrulestate).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
