...
Puppet::Type.newtype(:dsc_xexchowavirtualdirectory) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xExchOwaVirtualDirectory')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchOwaVirtualDirectory'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xExchOwaVirtualDirectory')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchOwaVirtualDirectory'
    end
