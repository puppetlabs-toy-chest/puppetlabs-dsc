...
Puppet::Type.newtype(:dsc_xexchwaitfordag) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xExchWaitForDAG')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchWaitForDAG'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xExchWaitForDAG')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchWaitForDAG'
    end
