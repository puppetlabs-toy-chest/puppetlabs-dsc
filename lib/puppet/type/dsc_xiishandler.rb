...
Puppet::Type.newtype(:dsc_xiishandler) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xIisHandler')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xIisHandler'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xIisHandler')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xIisHandler'
    end
