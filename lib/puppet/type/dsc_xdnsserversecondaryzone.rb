...
Puppet::Type.newtype(:dsc_xdnsserversecondaryzone) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xDnsServerSecondaryZone')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xDnsServerSecondaryZone'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xDnsServerSecondaryZone')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xDnsServerSecondaryZone'
    end
