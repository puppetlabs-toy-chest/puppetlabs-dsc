...
Puppet::Type.newtype(:dsc_xinternetexplorerhomepage) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xInternetExplorerHomePage')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xInternetExplorerHomePage'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('xInternetExplorerHomePage')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'xInternetExplorerHomePage'
    end
  ...
  newparam(:dscmeta_module_name) do
    desc "A read-only value that is the DSC Module Name ('xInternetExplorerHomePage')."

    validate do |value|
      fail 'dscmeta_module_name is read-only' if value != 'xInternetExplorerHomePage'
    end
