...
Puppet::Type.newtype(:dsc_windowsoptionalfeature) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('WindowsOptionalFeature')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'WindowsOptionalFeature'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_WindowsOptionalFeature')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_WindowsOptionalFeature'
    end
