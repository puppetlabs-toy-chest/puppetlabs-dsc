...
Puppet::Type.newtype(:dsc_xrdsessioncollectionconfiguration) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xRDSessionCollectionConfiguration')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xRDSessionCollectionConfiguration'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xRDSessionCollectionConfiguration')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xRDSessionCollectionConfiguration'
    end
