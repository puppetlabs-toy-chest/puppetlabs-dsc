...
Puppet::Type.newtype(:dsc_xscomconsolesetup) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCOMConsoleSetup')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSCOMConsoleSetup'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCOMConsoleSetup')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSCOMConsoleSetup'
    end
