...
Puppet::Type.newtype(:dsc_xexchexchangecertificate) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xExchExchangeCertificate')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xExchExchangeCertificate'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xExchExchangeCertificate')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xExchExchangeCertificate'
    end
