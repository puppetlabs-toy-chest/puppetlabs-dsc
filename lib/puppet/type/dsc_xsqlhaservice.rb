...
Puppet::Type.newtype(:dsc_xsqlhaservice) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSqlHAService')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSqlHAService'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSqlHAService')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSqlHAService'
    end
