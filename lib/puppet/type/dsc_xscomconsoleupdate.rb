...
Puppet::Type.newtype(:dsc_xscomconsoleupdate) do
  ...
  newparam(:dscmeta_resource_friendly_name) do
    desc "A read-only value that is the DSC Resource Friendly Name ('xSCOMConsoleUpdate')."

    validate do |value|
      fail 'dscmeta_resource_friendly_name is read-only' if value != 'xSCOMConsoleUpdate'
    end
  ...
  newparam(:dscmeta_resource_name) do
    desc "A read-only value that is the DSC Resource Name ('MSFT_xSCOMConsoleUpdate')."

    validate do |value|
      fail 'dscmeta_resource_name is read-only' if value != 'MSFT_xSCOMConsoleUpdate'
    end
