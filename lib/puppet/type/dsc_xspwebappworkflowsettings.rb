...
Puppet::Type.newtype(:dsc_xspwebappworkflowsettings) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xSPWebAppWorkflowSettings resource type.
    Automatically generated from
    'xSharePoint/Modules/xSharePoint/DSCResources/MSFT_xSPWebAppWorkflowSettings/MSFT_xSPWebAppWorkflowSettings.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xSPWebAppWorkflowSettings' end
  def dscmeta_resource_name; 'MSFT_xSPWebAppWorkflowSettings' end
...
Puppet::Type.type(:dsc_xspwebappworkflowsettings).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
